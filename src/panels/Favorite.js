          ...
          <Tabs theme="header" type="buttons">
            <HorizontalScroll>
              <TabsItem
                ...
                after={state.activeTab === 'all' && userMeets.length > 0 && <Counter size="s">{userMeets.length}</Counter>}
              >
                Все
              </TabsItem>
              <TabsItem
                ...
                after={state.activeTab === 'exp' && userMeets.length > 0 && <Counter size="s">{userMeets.length}</Counter>}
              >
                Завершенные
              </TabsItem>
              <TabsItem
                ...
                after={state.activeTab === 'my' && userMeets.length > 0 && <Counter size="s">{userMeets.length}</Counter>}
              >
                Созданные
              </TabsItem>
            </HorizontalScroll>
